...
/*
    SAIDA:
    O nome do fazendeiro que ganhou, da seguinte forma:
    ...
    seguido de uma quebra de linha com a quantidade de  leite que o ganhador produziu nos X dias, com duas casas decimais.
*/
#include <stdio.h>
#include <string.h>
#include <math.h>
